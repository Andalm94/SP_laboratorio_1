...
int ll_remove(LinkedList* this,int index){
    ...
    //**
    //**3-SI EL INDEX ES 0:
    //**** La dirección de memoria del primer nodo (this->pFirstNode) pasa a ser la direccion de memoria a la que esta apuntando el nodo a eliminar
...
int ll_clear(LinkedList* this){
    ...
    //**3-En cada iteración, elimino el primer nodo de la lista mediante la funcion 'll_remove' hasta que se hayan terminado todos los nodos
	//---------------------------------------------------------------------------------------------
    if(this != NULL){
    	returnAux = 0;
    	len =  ll_len(this);
